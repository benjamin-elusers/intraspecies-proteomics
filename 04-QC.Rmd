...
p_upset = ComplexUpset::upset(data=as.data.frame(1-na_int[,-1]),intersect=samples,
...
ggsave(p_upset,path=here('plot'),filename = 'upset-samples-combination-nacount.pdf', device = 'pdf',scale = 2)
ggsave(p_upset,path=here('plot'),filename = 'upset-samples-combination-nacount.png', device = 'png',scale = 2)

knitr::include_graphics(here('plot','upset-samples-combination-nacount.png'),auto_pdf = T)
```
