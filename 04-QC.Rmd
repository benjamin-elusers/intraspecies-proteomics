...
```{r na-samples, echo=F, fig.cap='Number of quantified intensities across samples', height=14, out.width='100%', width=14}
...
```{r boxplot-cv, echo=F, fig.cap='Coefficient of variations (%) in each sample and per strains before and after processing data (filtering and normalization)', width=14,height=14}
...
```{r exp_density}
#draw_normalization_density(int_raw,df.group)
```
