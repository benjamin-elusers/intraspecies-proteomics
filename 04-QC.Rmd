...
b1=draw_barplot_sumint(tot_int_raw,'Total intensity (raw)')+ scale_fill_metro()
b2=draw_barplot_sumint(tot_int_lfq,'Total intensity (lfq)')+ scale_fill_metro()
b3=draw_barplot_sumint(tot_int_norm,'Total intensity (normalized)') + scale_fill_metro()
b4=draw_barplot_sumint(tot_int_imp,'Total intensity (imputed)') + scale_fill_metro()
QC1 = plot( (b1| b2) / (b3 | b4) )

ggsave(QC1,filename =  here::here('plot','QC-total-intensities.png'), scale = 2)
