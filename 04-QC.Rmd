...
```{r boxplot-cv, echo=F, fig.cap='Coefficient of variations (%) in each sample and per strains before and after processing data (filtering and normalization)', fig.height=12, fig.width=12}
...
`r kbl("",ul_normalizations)`

```{r exp_density,fig.height=12, fig.width=12}
