```{r 04-load-data, echo=F}
#load(here('output','04-strain-comparison.rdata'))
```

# Differential Expression

```{r dfe, fig.path='plot/', fig.show='hold', warning=F, lightbox=T, gallery=T, out.width='100%',}
...
# Interactive treemap
shinyAppDir(
  itreemap(df_dfe_annot,
         index=c("BIOPROCESS_all", "GENENAME"),
         vSize="regulated", vColor="EffectSize",
         type="value"),
    options=list(
...
save.image(here('output','05-differential-expression.rdata'))
```