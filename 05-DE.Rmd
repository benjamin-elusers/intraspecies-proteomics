...
```{r dfe, fig.path='plot/', fig.show='hold', warning=F, lightbox=T, gallery=T, fig.height=15,fig.width=15}
...
```{r treemap-bioprocess, fig.path='plot/', fig.show='hold', warning=F, lightbox=T, gallery=T, fig.height=15,fig.width=15}
library(treemap)
library(d3Tree)
