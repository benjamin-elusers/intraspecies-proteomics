```{r 01-load-data, echo=F}
#load(here('output','01-proteomics.rdata'))
```
...
int_norm= center_intensities(int_raw, center='median', tolog2=T) %>% 
...
save.image(here('output','02-processed-data.rdata'))
```