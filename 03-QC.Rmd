...
```{r scatterplot-all, fig.path='plot/', fig.show='hold', warning=F, fig.height=20, fig.width=20}
...
```{r heatmap-all, fig.path='plot/', fig.show='hold', warning=F, fig.height=20,fig.width=20}
# heatmap correlation
...
```{r pca-all, fig.path='plot/', fig.show='hold', warning=F, fig.height=7,fig.width=7}
